...
CATEGORIES = {
    "agent-frameworks": {
        ...
        "queries": ["topic:llm-agent", "topic:agent-framework", "topic:ai-agents"],
        "curated": [
    ...
    "autonomous-agents": {
        ...
        "queries": ["topic:autonomous-agents", "topic:autogpt"],
        "curated": [
    ...
    "agent-protocols-infra": {
        ...
        "queries": ["topic:mcp", "topic:model-context-protocol", "topic:agent-orchestration"],
        "curated": [
    ...
    "agent-memory-tools": {
        ...
        "queries": ["topic:rag", "topic:vector-database", "topic:retrieval-augmented-generation"],
        "curated": [
    ...
    "agent-eval-observability": {
        ...
        "queries": ["topic:llm-evaluation", "topic:llmops", "topic:ai-observability"],
        "curated": [
    ...
    "coding-agents": {
        ...
        "queries": ["topic:ai-coding-assistant", "topic:coding-agent"],
        "curated": [
    ...
    "multi-agent-simulation": {
        ...
        "queries": ["topic:multi-agent-systems", "topic:generative-agents"],
        "curated": [
...
def main():
    ...
    for key, cat in CATEGORIES.items():
        ...
        for q in cat["queries"]:
            ...
            res = gh_api("search/repositories", {"q": q, "sort": "stars", "order": "desc", "per_page": 25})
            ...
            for r in res["items"]:
                ...
                if full in seen:
                    continue
                shaped = shape_repo(r)
                if shaped and shaped["stars"] >= 300:
                    shaped["category"] = key
                    seen[full] = shaped
